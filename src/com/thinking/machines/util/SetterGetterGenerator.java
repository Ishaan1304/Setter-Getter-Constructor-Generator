...
{
System.out.println("usage:java classpath path_to_jarfile;'com.thinking.machines.util.SetterGetterGenerator class_name constructor=true/false");
return;
}
if(gg.length==2)
{
...
System.out.println("Setter/Getter for: "+c.getName()+" generated in a file named as tmp.tmp");
